...
public class StatisticsTabActivity extends Activity implements ActionBar.TabListener {
    private static final int[] TabNames = new int[] {R.string.by_week,
            R.string.by_month, R.string.by_year, R.string.statistics_all};
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            return StatisticsFragment.newInstance(TabNames[position], DataManager.INVALID_CATE_ID);
        }
